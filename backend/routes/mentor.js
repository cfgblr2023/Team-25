...
Router.get('/batch/:mentorId', async (req, res) => {
    try {
        ...
        return res.status(200).json({ admin: newAdmin, success: true, message: "Batch fetched Successfully" });
    } catch (error) {
        return res.status(500).json({ message: error.message, success: false });
...
Router.get('/mentee/:menteeId', async (req, res) => {
    try {
        ...
        return res.status(200).json({ admin: newAdmin, success: true, message: "Mentee fetched Successfully" });
    } catch (error) {
        return res.status(500).json({ message: error.message, success: false });
